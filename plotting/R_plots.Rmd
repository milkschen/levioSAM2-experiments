...
filenames <- c("grch38", "grch38_masked", "chm13_to_grch38", "hg19", "chm13_to_hg19", "grch37", "chm13_to_grch37", "chm13_to_hg19")
printednames <- c("GRCh38", "GRCh38-masked", "CHM13-to-GRCh38", "GRCh37", "CHM13-to-GRCh37", "GRCh37", "CHM13-to-GRCh37", "CHM13-to-GRCh37")
...
df_hg002_bwa_dv_stratify_grc <- do.call(rbind, lapply(c("chm13v2/hg002/stratify/grch38.extended.csv", "chm13v2/hg002/stratify/grch37.extended.csv"), read_csv, map=map_caller_name)) %>% filter(Subtype == "*", Filter == "PASS", Subset.IS_CONF.Size > 5e6, Subset %in% strat_subsets)
...
df_hg002_bwa_dv_stratify_leviosam <- do.call(rbind, lapply(c("chm13v2/hg002/stratify/chm13_to_grch38.extended.csv", "chm13v2/hg002/stratify/chm13_to_grch37.extended.csv"), read_csv, map=map_caller_name)) %>% filter(Subtype == "*", Filter == "PASS", Subset.IS_CONF.Size > 5e6, Subset %in% strat_subsets)
