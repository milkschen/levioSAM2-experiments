...
df_hg002_bwa_dv_stratify <- df_hg002_bwa_dv_stratify %>% mutate(h38 = ifelse(name %in% c("GRCh38", "CHM13-to-GRCh38"), "h38", "h37"), pair = (name %in% c("GRCh38", "CHM13-to-GRCh38") * 1) + (Type == "SNP") * 10)
...
# library(ggbreak)
# fig_hg002_bwa_dv_stratify_scatter + scale_y_break(c(0.71, 0.83)) 
...
# # df_sim_chr21_NA12878 <- df_sim_chr21_NA12878 %>% mutate(correct = (rname == gold_rname & abs(pos - gold_pos) <= 10), Positive = (correct) * 1, Negative = (correct == FALSE & pos >= 0) * 1, NoCall = (pos < 0) * 1)

# df_sim_chr21_NA12878_bwa_lev <- read.delim("sim_NA12878/chr21/NA12878-bwa-lev.tsv", header = TRUE, sep = "\t") %>% mutate(method = "CHM13-to-GRCh38", aligner = "BWA MEM")
# df_sim_chr21_NA12878_bwa_grc <- read.delim("sim_NA12878/chr21/NA12878-bwa-grch38.tsv", header = TRUE, sep = "\t") %>% mutate(method = "GRCh38", aligner = "BWA MEM")
# df_sim_chr21_NA12878_bt2_lev <- read.delim("sim_NA12878/chr21/NA12878-bt2-lev.tsv", header = TRUE, sep = "\t") %>% mutate(method = "CHM13-to-GRCh38", aligner = "Bowtie 2")
# df_sim_chr21_NA12878_bt2_grc <- read.delim("sim_NA12878/chr21/NA12878-bt2-grch38.tsv", header = TRUE, sep = "\t") %>% mutate(method = "GRCh38", aligner = "Bowtie 2")
df_sim_chr21_NA12878_bwa_lev <- read.delim("sim_NA12878/chr21/NA12878-bwa-lev.tsv", header = TRUE, sep = "\t") %>% mutate(ref = "CHM13-to-GRCh38", aligner = "BWA MEM", method = "BWA MEM, CHM13-to-GRCh38")
df_sim_chr21_NA12878_bwa_grc <- read.delim("sim_NA12878/chr21/NA12878-bwa-grch38.tsv", header = TRUE, sep = "\t") %>% mutate(ref = "GRCh38", aligner = "BWA MEM", method = "BWA MEM, GRCh38")
df_sim_chr21_NA12878_bt2_lev <- read.delim("sim_NA12878/chr21/NA12878-bt2-lev.tsv", header = TRUE, sep = "\t") %>% mutate(ref = "CHM13-to-GRCh38", aligner = "Bowtie 2", method = "Bowtie 2, CHM13-to-GRCh38")
df_sim_chr21_NA12878_bt2_grc <- read.delim("sim_NA12878/chr21/NA12878-bt2-grch38.tsv", header = TRUE, sep = "\t") %>% mutate(ref = "GRCh38", aligner = "Bowtie 2", method = "Bowtie 2, GRCh38")

df_sim_chr21_NA12878 <- rbind(df_sim_chr21_NA12878_bwa_lev, df_sim_chr21_NA12878_bwa_grc, df_sim_chr21_NA12878_bt2_lev, df_sim_chr21_NA12878_bt2_grc) %>% mutate(
